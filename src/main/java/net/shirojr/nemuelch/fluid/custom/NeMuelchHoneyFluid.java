...
public abstract class NeMuelchHoneyFluid extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return NeMuelchFluid.HONEY_FLOWING;
    }

    @Override
    public Fluid getStill() {
        return NeMuelchFluid.HONEY_STILL;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return NeMuelchBlocks.HONEY_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends NeMuelchHoneyFluid {
