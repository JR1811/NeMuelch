...
public class WateringCanBlockEntity extends BlockEntity {
    ...
    public static final int FILL_RATE = NeMuelchConfigInit.CONFIG.wateringCan.getFillRate();
    public static final int FILL_CHANCE = NeMuelchConfigInit.CONFIG.wateringCan.getFillChance();
    ...
    public void setShouldFill(boolean shouldFill) {
        ...
        LoggerUtil.devLogger("Should fill set to true");
    }
    ...
    public static void tick(World world, BlockPos blockPos, BlockState blockState, WateringCanBlockEntity entity) {
        ...
        if (!(blockState.getBlock() instanceof WateringCanBlock)) return;
