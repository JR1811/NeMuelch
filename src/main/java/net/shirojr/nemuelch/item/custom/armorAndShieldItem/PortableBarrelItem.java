...
public class PortableBarrelItem extends ArmorItem implements IAnimatable {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        if (livingEntity instanceof ArmorStandEntity) {
            ...
            boolean isWearingAll = new HashSet<>(armorList).contains(NeMuelchItems.PORTABLE_BARREL);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (Screen.hasShiftDown()) {
            ...
            LiteralText status = new LiteralText("[" + stack.getOrCreateNbt().getInt(NBT_KEY_FILL_STATUS) + "/" + NeMuelchConfigInit.CONFIG.portableBarrelMaxFill + "] ");
