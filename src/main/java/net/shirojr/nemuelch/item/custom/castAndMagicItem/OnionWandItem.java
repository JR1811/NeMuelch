...
public class OnionWandItem extends ToolItem {
    public OnionWandItem(Settings settings) {
        super(NeMuelchToolMaterials.ONION_WAND, settings);
    }

    private static final int USE_COOLDOWN_TICKS = 600;
    private static final int MIN_SPAWN_COUNT = NeMuelchConfigInit.CONFIG.onion.getToolData().getMinAmountSpawn();
    private static final int MAX_SPAWN_COUNT = NeMuelchConfigInit.CONFIG.onion.getToolData().getMaxAmountSpawn() + 1;
