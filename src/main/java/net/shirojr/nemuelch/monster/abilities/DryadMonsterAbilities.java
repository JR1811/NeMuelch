...
public class DryadMonsterAbilities extends AbstractMonsterAbilities {
    public DryadMonsterAbilities(AbstractMonsterType monsterType) {
        super(monsterType);
    }
    ...
    @Override
    protected ActionResult doOnInteractEntity(PlayerEntity player, World world, Hand hand, Entity target, @Nullable EntityHitResult hitResult) {
