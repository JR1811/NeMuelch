...
import net.shirojr.nemuelch.monster.abilities.WerwolfMonsterAbilities;

public class WerwolfMonsterType extends AbstractMonsterType {
    public static final Identifier IDENTIFIER = NeMuelch.getId("werwolf");
    ...
    protected AbstractMonsterAbilities createAbilities() {
        return new WerwolfMonsterAbilities(this);
    }
